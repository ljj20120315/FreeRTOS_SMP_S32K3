...
#define RM_SEMA42_IP_SW_MAJOR_VERSION_C               1
...
static SEMA42_Type * const Sema42_Ip_Base[SEMA42_INSTANCE_COUNT] = IP_SEMA42_BASE_PTRS;
 ...
 * @pre
 */
/* @implements    Sema42_Ip_Init_Privileged_Activity */
void Sema42_Ip_Init_Privileged(const uint32 u32Instance)
{
    SEMA42_Type * base;
#if (SEMA42_IP_DEV_ERROR_DETECT == STD_ON)
    /* Check the input parameters */
    DevAssert(u32Instance < (uint32)SEMA42_INSTANCE_COUNT);
#endif
 ...
 *
 */
/* @implements    Sema42_Ip_LockGate_Privileged_Activity */
uint8 Sema42_Ip_LockGate_Privileged(const uint32 u32Instance, const uint8 u8GateIndex, uint8 u8DomainId)
{
    SEMA42_Type * base;
    uint8 gateStatus;
...
#if (SEMA42_IP_DEV_ERROR_DETECT == STD_ON)
    /* Check the input parameters */
    DevAssert(u32Instance < (uint8)SEMA42_INSTANCE_COUNT);
 ...
 *
 */
/* @implements    Sema42_Ip_UnlockGate_Privileged_Activity */
uint8 Sema42_Ip_UnlockGate_Privileged(const uint32 u32Instance, const uint8 u8GateIndex)
{
    SEMA42_Type * base;
    uint8 gateStatus;
...
#if (SEMA42_IP_DEV_ERROR_DETECT == STD_ON)
    /* Check the input parameters */
    DevAssert(u32Instance < SEMA42_INSTANCE_COUNT);
    DevAssert(u8GateIndex < SEMA42_GATE_COUNT);
#endif
 ...
 *
 */
/* @implements    Sema42_Ip_ResetGate_Privileged_Activity */
void Sema42_Ip_ResetGate_Privileged(const uint32 u32Instance, const uint8 u8GateIndex)
{
    SEMA42_Type * base;
 ...
 *
 */
/* @implements    Sema42_Ip_GetGateLocker_Privileged_Activity */
uint8 Sema42_Ip_GetGateLocker_Privileged(const uint32 u32Instance, const uint8 u8GateIndex)
{
 ...
 *
 */
/* @implements    Sema42_Ip_IsResetGateStateIdle_Privileged_Activity */
uint8 Sema42_Ip_IsResetGateStateIdle_Privileged(const uint32 u32Instance)
{
    uint8 gateStatus;
    const SEMA42_Type * base;
 ...
 *
 */
/* @implements    Sema42_Ip_GetResetGateBusMaster_Privileged_Activity */
uint8 Sema42_Ip_GetResetGateBusMaster_Privileged(const uint32 u32Instance)
{
    const SEMA42_Type * base;
    uint8 DomainNumber;
 ...
 *
 */
/* @implements    Sema42_Ip_GetResetGateIndex_Privileged_Activity */
uint8 Sema42_Ip_GetResetGateIndex_Privileged(const uint32 u32Instance)
{
    const SEMA42_Type * base;
    uint8 ResetGate;
