...
#define RM_SEMA42_IP_SW_MAJOR_VERSION               1
...
#if (RM_SEMA42_IP_VENDOR_ID != RM_SEMA42_IP_CFG_DEFINES_VENDOR_ID)
    #error "Sema42_Ip.h and Sema42_Ip_Cfg_Defines.h have different vendor ids"
#endif
#if ((RM_SEMA42_IP_AR_RELEASE_MAJOR_VERSION    != RM_SEMA42_IP_CFG_DEFINES_AR_RELEASE_MAJOR_VERSION) || \
     (RM_SEMA42_IP_AR_RELEASE_MINOR_VERSION    != RM_SEMA42_IP_CFG_DEFINES_AR_RELEASE_MINOR_VERSION) || \
     (RM_SEMA42_IP_AR_RELEASE_REVISION_VERSION != RM_SEMA42_IP_CFG_DEFINES_AR_RELEASE_REVISION_VERSION) \
    )
     #error "AUTOSAR Version Numbers of Sema42_Ip.h and Sema42_Ip_Cfg_Defines.h are different"
#endif
#if ((RM_SEMA42_IP_SW_MAJOR_VERSION != RM_SEMA42_IP_CFG_DEFINES_SW_MAJOR_VERSION) || \
     (RM_SEMA42_IP_SW_MINOR_VERSION != RM_SEMA42_IP_CFG_DEFINES_SW_MINOR_VERSION) || \
     (RM_SEMA42_IP_SW_PATCH_VERSION != RM_SEMA42_IP_CFG_DEFINES_SW_PATCH_VERSION) \
    )
    #error "Software Version Numbers of Sema42_Ip.h and Sema42_Ip_Cfg_Defines.h are different"
#endif
