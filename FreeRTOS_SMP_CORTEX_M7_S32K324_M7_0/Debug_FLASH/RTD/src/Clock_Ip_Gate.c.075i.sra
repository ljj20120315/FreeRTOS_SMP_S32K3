Creating summary for Clock_Ip_ClockUpdateGateMcMePartitionCollectionClockRequest/3:
  Descriptor for parameter 0 ClockNameD.6578
    not a candidate for splitting
  Descriptor for parameter 1 GateD.6579
    not a candidate for splitting


Creating summary for Clock_Ip_ClockSetGateMcMePartitionCollectionClockRequest/2:
  Descriptor for parameter 0 ConfigD.6563
    not a candidate
----------------------------------------
  Descriptor for parameter 0 ConfigD.6563
    not a candidate for splitting
...
Creating summary for Clock_Ip_ClockUpdateGateEmpty/1:
  Descriptor for parameter 0 ClockNameD.6559
    (locally) unused
    not a candidate for splitting
  Descriptor for parameter 1 GateD.6560
    (locally) unused
    not a candidate for splitting


Creating summary for Clock_Ip_ClockSetGateEmpty/0:
  Descriptor for parameter 0 ConfigD.6556
...
Summary for node Clock_Ip_ClockSetGateMcMePartitionCollectionClockRequest/2:
  ...
  Summary for edge Clock_Ip_ClockSetGateMcMePartitionCollectionClockRequest/2->Clock_Ip_TimeoutExpired/12:
  Summary for edge Clock_Ip_ClockSetGateMcMePartitionCollectionClockRequest/2->Clock_Ip_StartTimeout/11:
    return value ignored
  Summary for edge Clock_Ip_ClockSetGateMcMePartitionCollectionClockRequest/2->Clock_Ip_McMeEnterKey/10:
    return value ignored
  Summary for edge Clock_Ip_ClockSetGateMcMePartitionCollectionClockRequest/2->Clock_Ip_ReportClockErrors/13:
    return value ignored
    Parameter 0:
