...
Jump functions:
  Jump functions of caller  OsIf_Timer_System_MicrosToTicks/14:
  Jump functions of caller  OsIf_Timer_System_SetTimerFrequency/13:
  Jump functions of caller  OsIf_Timer_System_GetElapsed/12:
  Jump functions of caller  OsIf_Timer_System_GetCounter/11:
  Jump functions of caller  OsIf_Timer_System_Init/10:
  Jump functions of caller  OsIf_MicrosToTicks/9:
    callsite  OsIf_MicrosToTicks/9 -> OsIf_Timer_System_MicrosToTicks/14 : 
       no arg info
  Jump functions of caller  OsIf_SetTimerFrequency/8:
    callsite  OsIf_SetTimerFrequency/8 -> OsIf_Timer_System_SetTimerFrequency/13 : 
       no arg info
  Jump functions of caller  OsIf_GetElapsed/7:
    callsite  OsIf_GetElapsed/7 -> OsIf_Timer_System_GetElapsed/12 : 
       no arg info
  Jump functions of caller  OsIf_GetCounter/6:
    callsite  OsIf_GetCounter/6 -> OsIf_Timer_System_GetCounter/11 : 
       no arg info
  Jump functions of caller  OsIf_Init/5:
    callsite  OsIf_Init/5 -> OsIf_Timer_System_Init/10 : 
       no arg info
...
;; Function OsIf_Init (OsIf_Init, funcdef_no=5, decl_uid=5705, cgraph_uid=6, symbol_order=5)
...
;; Function OsIf_GetCounter (OsIf_GetCounter, funcdef_no=6, decl_uid=5707, cgraph_uid=7, symbol_order=6)
...
;; Function OsIf_GetElapsed (OsIf_GetElapsed, funcdef_no=7, decl_uid=5710, cgraph_uid=8, symbol_order=7)
...
;; Function OsIf_SetTimerFrequency (OsIf_SetTimerFrequency, funcdef_no=8, decl_uid=5713, cgraph_uid=9, symbol_order=8)
...
;; Function OsIf_MicrosToTicks (OsIf_MicrosToTicks, funcdef_no=9, decl_uid=5716, cgraph_uid=10, symbol_order=9)
