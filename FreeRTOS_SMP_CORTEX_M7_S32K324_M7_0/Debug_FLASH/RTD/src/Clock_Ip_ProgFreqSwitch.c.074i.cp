...
Jump functions:
  ...
  Jump functions of caller  Clock_Ip_CgmXPcfsSdurDivcDiveDivs/1:
    callsite  Clock_Ip_CgmXPcfsSdurDivcDiveDivs/1 -> Clock_Ip_GetConfiguredFrequencyValue/6 : 
       no arg info
...
;; Function Clock_Ip_ProgressiveFrequencyClockSwitchEmpty (Clock_Ip_ProgressiveFrequencyClockSwitchEmpty, funcdef_no=0, decl_uid=6547, cgraph_uid=1, symbol_order=0)
...
;; Function Clock_Ip_CgmXPcfsSdurDivcDiveDivs (Clock_Ip_CgmXPcfsSdurDivcDiveDivs, funcdef_no=1, decl_uid=6549, cgraph_uid=2, symbol_order=1)
