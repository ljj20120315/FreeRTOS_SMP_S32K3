...
;; Function NVIC_SetPriorityGrouping (NVIC_SetPriorityGrouping, funcdef_no=0, decl_uid=8995, cgraph_uid=1, symbol_order=0)
...
;; Function NVIC_EnableIRQ (NVIC_EnableIRQ, funcdef_no=1, decl_uid=8997, cgraph_uid=2, symbol_order=1)
...
;; Function NVIC_DisableIRQ (NVIC_DisableIRQ, funcdef_no=2, decl_uid=8999, cgraph_uid=3, symbol_order=2)
...
;; Function NVIC_SetPriority (NVIC_SetPriority, funcdef_no=3, decl_uid=9002, cgraph_uid=4, symbol_order=3)
