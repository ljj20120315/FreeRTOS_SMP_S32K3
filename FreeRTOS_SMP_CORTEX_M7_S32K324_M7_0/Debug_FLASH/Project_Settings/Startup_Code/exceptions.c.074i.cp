...
;; Function NMI_Handler (NMI_Handler, funcdef_no=0, decl_uid=5705, cgraph_uid=1, symbol_order=0)
...
;; Function HardFault_Handler (HardFault_Handler, funcdef_no=1, decl_uid=5707, cgraph_uid=2, symbol_order=1)
...
;; Function MemManage_Handler (MemManage_Handler, funcdef_no=2, decl_uid=5709, cgraph_uid=3, symbol_order=2)
...
;; Function BusFault_Handler (BusFault_Handler, funcdef_no=3, decl_uid=5711, cgraph_uid=4, symbol_order=3)
...
;; Function UsageFault_Handler (UsageFault_Handler, funcdef_no=4, decl_uid=5713, cgraph_uid=5, symbol_order=4)
...
;; Function SVC_Handler (SVC_Handler, funcdef_no=5, decl_uid=5743, cgraph_uid=6, symbol_order=5)
...
;; Function DebugMon_Handler (DebugMon_Handler, funcdef_no=6, decl_uid=5715, cgraph_uid=7, symbol_order=6)
...
;; Function PendSV_Handler (PendSV_Handler, funcdef_no=7, decl_uid=5717, cgraph_uid=8, symbol_order=7)
...
;; Function SysTick_Handler (SysTick_Handler, funcdef_no=8, decl_uid=5719, cgraph_uid=9, symbol_order=8)
...
;; Function undefined_handler (undefined_handler, funcdef_no=9, decl_uid=5721, cgraph_uid=10, symbol_order=9) (executed once)
