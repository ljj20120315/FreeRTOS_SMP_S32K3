...
#define LED_DID0_PIN            8u
#define LED_DID0_PORT           PTF_L_HALF
#define LED_DID1_PIN            9u
#define LED_DID1_PORT           PTF_L_HALF
#define UART_TX_PIN             11u
#define UART_TX_PORT            PTA_H_HALF
#define UART_RX_PIN             12u
#define UART_RX_PORT            PTA_H_HALF
#define SW_DID0_PIN             4u
#define SW_DID0_PORT            PTC_H_HALF
#define SW_DID1_PIN             5u
#define SW_DID1_PORT            PTC_H_HALF
